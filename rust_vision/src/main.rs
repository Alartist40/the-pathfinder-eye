...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let yolo_model = if Path::new("/home/pi/the-pathfinder-eye_ai/models/yolov8n-640.onnx").exists() {
        "/home/pi/the-pathfinder-eye_ai/models/yolov8n-640.onnx"
    } else {
        "/home/pi/the-pathfinder-eye_ai/models/yolov5s-640.onnx"
    };
    let mut yolo = YOLODetector::new(yolo_model)?;
