...
# Qwen3.5-2B-Q4_K_M — ~1.3GB, fast and reliable on Pi 5 / Pi 4
LLM_MODEL="$MODELS_DIR/Qwen3.5-2B-Q4_K_M.gguf"
LLM_URL="https://huggingface.co/bartowski/Qwen3.5-2B-GGUF/resolve/main/Qwen3.5-2B-Q4_K_M.gguf"
